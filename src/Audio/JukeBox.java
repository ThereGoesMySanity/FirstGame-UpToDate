...
public class JukeBox {
	private static HashMap<String, FloatControl> volumes;
	...
	public static void init() {
		...
		volumes = new HashMap<String, FloatControl>();
		gap = 0;
	}
	...
	public static void load(String s, String n) {
		...
		try {
			...
			clip.open(dais);
			clips.put(n, clip);
			volumes.put(n, (FloatControl) clip.getControl(FloatControl.Type.MASTER_GAIN));
		}
		catch(Exception e) {
			e.printStackTrace();
		}
